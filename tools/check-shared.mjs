...
// are duplicated byte-for-byte in the sibling repo acurioustale/comparebuilds-app
...
if (problems.length) {
  ...
  console.error(
    "\n  This bundle is mirrored byte-for-byte in acurioustale/comparebuilds-app.\n" +
